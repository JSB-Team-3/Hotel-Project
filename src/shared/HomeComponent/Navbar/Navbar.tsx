...
import { AppBar, Toolbar, IconButton, Container, Avatar, Tooltip, 
  Box,  Badge, useMediaQuery, useScrollTrigger, Slide, alpha
} from '@mui/material';
...
const Navbar = () => {
  ...
  const {isLoggedIn,userProfile,PAGES,isActive,drawerOpen,anchorEl,
    favoriteCount,toggleDrawer,closeDrawer,handleMenuOpen,
    handleMenuClose,
    handleLogout,goToFavorites
  } = useNavbarState();
